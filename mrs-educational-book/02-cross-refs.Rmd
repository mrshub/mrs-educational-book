...
[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/L1-BasicsOfMRS_Fillmer.pdf) 
...
[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/L4-Postprocessing%26Quantification_Oeltzschner.pdf)
...
[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/L2_LocalizationMethods_Riemann.pdf)
...
[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/L3-Calib%26Workflow_Fillmer.pdf)
...
[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/high%20field%20workshop%20Heidelberg%20Kan.pdf) 
...
[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/MRS%20in%20neuromuscular%20disease%20Inspector.pdf) 
...
[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/NMR_J-Coupling_201201_Lecture_3_CouplingConstants_Harvard_Kwan_EE.pdf)
...
[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/presentation_INEPT_MRS_sequence.pdf)
...
[PDF](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/MRS%20workshop%202018%20Youtube%20program.pdf)

## 2020-2018 ISMRM courses– 
...
[Spreadsheet](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/2020-2018_ISMRM_courses_01042022.xlsx) PS: Click on "view raw" to download it.
 
## 2023 MR Spectroscopy Hackathon Educational Track

```Beginner```

```Keywords:``` *spectroscopy*, *reproducibility*, *R*

From Basics to Brilliance: An Introduction to RStudio for MR spectroscopy analysis, visualization, and beyond

[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/hackathon-2023/Archibald_R-educational_MRSHackathon.pdf) 

***Jessica Archibald, PhD*** 

```Beginner```

```Keywords:``` *spectroscopy*, *reproducibility*, *data management*

Collaborating with yourself: Best practices for managing data, code, and results for MRS analysis projects

[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/hackathon-2023/DaviesJenkins_MRSHackathonSlides.pdf) 

***Christopher Davies-Jenkins, PhD*** 

```Beginner```

```Keywords:``` *spectroscopy*, *coding*

Intro to best coding practices for shared projects

[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/hackathon-2023/LaMaster_MRS Hackathon 2023_slides.pdf) 

***John LaMaster, MSc*** 

```Beginner```

```Keywords:``` *spectroscopy*, *artifacts*

In-vivo MRS: A Gallery of Artifacts revisited

[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/hackathon-2023/MacMillan_MRS_Artifacts_2023_MRSHackathon.pdf) 
...
```Keywords:``` *spectroscopy*, *processing*, *simulation*, *FID-A*

MRS simulation and preprocessing using the FID-A toolkit

[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/hackathon-2023/Near_FID-A_MRSHackathon2023.pdf) 

***Jamie Near, PhD***

```Beginner```

```Keywords:``` *spectroscopy*, *coding*, *git*

Tools for productive hacking (basic unix commands, basics of git)

[Slide](https://github.com/mrshub/mrs-educational-book/blob/main/libraries/hackathon-2023/Ozdemir_MRSHackathon_slides.pdf) 
